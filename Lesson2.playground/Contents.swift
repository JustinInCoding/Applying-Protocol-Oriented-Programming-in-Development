...
let oppenheimer = Movie(title: "Opeenheimer", price: 17.99, duration: 180)
...
extension MediaCollection {
	...
	func getDescription() -> String {
		"Collection contains \(items.count) movies"
	}
}
...
extension MediaShelf where T == VideoGame {
	func getDescription() -> String {
		...
		return "The collection contains \(xBoxCount) Xbox games, \(playStationCount) Playstation games and \(switchCount) Switch games"
	}
}
...
let notTimeToDie = Movie(title: "No Time To Die", price: 19.99, duration: 163)
